                            ...
                            isAdmin === false ?
                                <div className=' relative inline-block' ref={myPageRef} onClick={handleToggleMyPage}>
                                    ...
                                    <div className={`absolute top-[32px] left-[-40px] min-w-[200px] px-auto pt-3 bg-[#32769b] transition-all duration-300 ${myPageActive ? 'inline-block' : 'hidden'}`}>
                                        ...
                                        <div className=' text-[17px] py-3 text-white border-b border-b-white/50 cursor-pointer' onClick={() => history.push('/contact-general')}>総合窓口</div>
                                        <div className=' text-[17px] py-3 text-white cursor-pointer' onClick={handleLogout}>ログアウト</div>
                                    </div>
                                </div>
                                :
