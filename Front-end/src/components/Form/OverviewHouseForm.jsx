    ...
    <div>
      <div className=" w-[803px]  flex gap-[110px]">
        <div className="w-[190px] flex gap-[35px]  ">
          <span className="bg-[#63A4D4] h-[28px] flex items-center p-2 rounded-md text-[15px] mx-[12px] text-white">
            任意
          </span>
        ...
        <div className="flex">
          ...
          <input
            type="number"
            placeholder="万円"
            className="w-[381px] border-[1px] focus:outline-none focus:border-blue-500 p-1 border-black rounded-md"
      ...
      <div className=" w-[803px]  flex gap-[124px] pt-[18px] justify-end">
        <div className="flex">
          <span className="text-[20px] pr-5">駐車場</span>
          <input
            type="text"
            placeholder=""
            className="w-[381px] border-[1px] focus:outline-none focus:border-blue-500 p-1 border-black rounded-md"
