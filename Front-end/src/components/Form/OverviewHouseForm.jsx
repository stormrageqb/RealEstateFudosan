  ...
  return (
    <div className="flex flex-col gap-4 lg:flex-row lg:justify-between lg:items-start w-[90%] sm:w-[445px] lg:w-full">
      ...
      <div className="flex flex-col sm:w-[445px] gap-8">
        ...
        <div className="flex justify-between w-full">
          <span className="text-base sm:text-[20px]">間取り</span>
          <input
            type="text"
            placeholder="4LDK"
            className="w-[200px] sm:w-[280px] border-[1px] focus:outline-none focus:border-blue-500 p-1 border-black rounded-md"
        ...
        <div className="flex justify-between w-full">
          <span className="text-base sm:text-[20px]">建物面積</span>
          <input
            type="number"
            placeholder="m²"
            className="w-[200px] sm:w-[280px] border-[1px] focus:outline-none focus:border-blue-500 p-1 border-black rounded-md"
        ...
        <div className="flex justify-between w-full">
          <span className="text-base sm:text-[20px]">入居日付</span>
          <input
            type="text"
            className="w-[200px] sm:w-[280px] border-[1px] focus:outline-none focus:border-blue-500 p-1 border-black rounded-md"
        ...
        <div className="flex justify-between w-full">
          <span className="text-base sm:text-[20px]">駐車場</span>
          <input
            type="text"
            placeholder=""
            className="w-[200px] sm:w-[280px] border-[1px] focus:outline-none focus:border-blue-500 p-1 border-black rounded-md"
