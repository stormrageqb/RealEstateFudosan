...
const SearchBoard = (props) => {
  ...
  const magnifierToggleHandler = props.magnifierToggleHandler;
  ...
  return (
    <>
      <div
        ref={searchRef}
        className="fixed bottom-1/2 right-1/2 transform translate-x-1/2 translate-y-1/2 z-50 bg-white border-2 border-black/40 rounded-xl font-normal shadow-2xl"
      >
        <div className="w-[355px]" id="search">
          <div className="flex justify-end">
            <i
              className=" fa-solid fa-x text-lg pr-[30px] pt-[24px] cursor-pointer"
              onClick={magnifierToggleHandler}
            ></i>
          </div>
          <div className="flex">
            <i className="fa-solid fa-magnifying-glass text-2xl pl-[42px] pt-[4px]"></i>
            <p className="text-[24px] pl-[18px] font-medium flex items-center">
              マイサーチ
            </p>
          </div>
          <div className="pt-8 flex items-center justify-between pr-14">
            ...
            >
              ...
              <option className="text-[16px]" value="掲載が新しい順">
                &nbsp;掲載が新しい順
              </option>
              <option className="text-[16px]" value="掲載が古い順">
                &nbsp;掲載が古い順
              </option>
              <option
                className="text-[18px] font-bold "
              ...
              <option className="text-[16px]" value="安い順">
                &nbsp;安い順
              </option>
              <option className="text-[16px]" value="高い順">
                &nbsp;高い順
              </option>
            </select>
          </div>
          <p className=" text-base font-medium mx-auto pl-[35%] pt-6 pb-3">
            絞込み検索
          </p>
          <div className="pt-[16px] flex items-center justify-between pr-14">
            ...
            >
              <option className="text-[16px]" value=""></option>
              <option className="text-[16px]" value="表示する">
                &nbsp;表示する
              </option>
              <option className="text-[16px]" value="表示しない">
                &nbsp;表示しない
              </option>
            </select>
          </div>
          ...
          <div className="flex justify-center pt-8">
            <button
              className="border border-black rounded-md p-2 text-sm font-medium"
          ...
          <div className="flex justify-center pt-8 pb-20">
            <button
              className=" bg-[#2A6484]  rounded-xl py-[12px] px-[47px] text-[16px] text-white "
              onClick={handleSaveAndDisplayBtnClicked}
            >
              設定を保存/表示する
            </button>
          </div>
      ...
      <div
        className="opacity-75 bg-black fixed inset-0 z-40"
        id="searchBackground"
      ></div>
    </>
  );
