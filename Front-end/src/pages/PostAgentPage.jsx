...
const PostAgentPage = () => {
    ...
    const agentData = {
        posterId: newId, agentName: agentName, agentEmail: email, address: address,
        ...
        <div className='bg-[#F1F1F1]  pt-[124px]'>
            <div className='container bg-white'>
                ...
                <form onSubmit={handleSubmit} encType='multipart/form-data'>
                    ...
                    <div className=' w-[900px] ml-[310px]  flex gap-[169px] mt-[40px]'>
                        <UploadImageForm title="資格コピー" button="資格のコピーをアップロード" width1={"w-[800px]"} width2={"w-[300px]"} gap={"gap-[35px]"} onDataArrayFromChild={handleUploadDataArray} />
                    </div>
