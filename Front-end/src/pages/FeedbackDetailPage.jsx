...
const FeedbackDetailPage = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-[40px] mb-[80px]'>
        <div>
            {category === 'bought' && <p className='text-[32px] text-center noto-medium'>売主さんへの手紙</p>}
            {category === 'sold' && <p className='text-[32px] text-center noto-medium'>売りました体験談</p>}
        </div>
        ...
        <div className='flex flex-col items-center w-[1300px] mt-[100px]'>
            <p className='w-[90%] p-2 mb-10 text-xl noto-medium'>{shortComment}</p>
            <p className='text-[16px] noto-regular border-2 border-black/40 p-2 mt-[40px]'>{fullComment}</p>
