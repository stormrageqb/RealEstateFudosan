...
const FeedbackDetailPage = () => {
  ...
  return (
    <div className="flex flex-col items-center mt-[40px] mb-[80px]">
      ...
      <div className="w-full px-10 pt-[72px] flex items-center justify-between">
        {category === "bought" && (
      ...
      <div className="flex flex-col items-center w-full mx-auto">
        ...
        <button
          className="bg-[#2A6484] text-[24px] text-white px-[42px] py-[25px] mt-[80px] rounded-xl"
