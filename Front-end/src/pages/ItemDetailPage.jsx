  ...
  return (
    <div className=" flex flex-col items-center pb-[120px] pt-[92px] w-full">
      ...
      <div className="w-[1300px] mx-auto">
        ...
        <div className="w-[90%] mx-auto text-xl font-normal">
          {realEstate.briefDescription}
        </div>
        <div className=" border-2 border/60-black p-3 text-base font-normal mt-14">
          {realEstate.fullDescription}
        </div>

        <div className="flex justify-center gap-[50px] w-full mt-20">
          <div
            className="flex justify-center items-center w-[380px] h-[80px] bg-[#2A6484] rounded-xl font-medium text-white text-[24px] cursor-pointer"
